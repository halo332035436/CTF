...
public class SalesRankingSelectActivity extends AppCompatActivity {
    private SalesRankingRecyclerViewAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(viewableDepartments.size()==1){
            ...
            intent.setClass(this,SalesRankingActivity.class);
            if(!viewableDepartments.get(0).id.equals(user.department_id)){
    ...
    private void initUi(){
        ...
        adapter = new SalesRankingRecyclerViewAdapter(this, dataList);
