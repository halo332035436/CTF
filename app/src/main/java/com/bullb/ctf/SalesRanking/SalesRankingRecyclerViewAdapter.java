...
public class SalesRankingRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    public static ArrayList<Department> dataList;
    final Context mContext;
    private final LayoutInflater mLayoutInflater;
    private static final int TYPE_ITEM = 1;

    public SalesRankingRecyclerViewAdapter(Context context, ArrayList<Department> dataList) {
        ...
        if (holder instanceof ItemViewHolder) {
            ...
            viewHolder.layout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    intent.setClass(mContext,SalesRankingActivity.class);
