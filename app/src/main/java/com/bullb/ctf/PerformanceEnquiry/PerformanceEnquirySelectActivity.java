...
public class PerformanceEnquirySelectActivity extends AppCompatActivity {
    private PerformanceEnquiryRecyclerViewAdapter adapter;
...
//            intent.setClass(this,PerformanceEnquiryActivity.class);
...
//        }
    ...
    private void initUi(){
        ...
        adapter = new PerformanceEnquiryRecyclerViewAdapter(this, dataList);
