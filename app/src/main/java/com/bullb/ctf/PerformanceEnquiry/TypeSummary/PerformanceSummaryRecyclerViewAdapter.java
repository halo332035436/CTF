...
import com.bullb.ctf.TargetManagement.TargetManagementSelectRecyclerViewAdapter;
...
public class PerformanceSummaryRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public PerformanceSummaryRecyclerViewAdapter(Context context, ArrayList<Department> dataList, Fragment fragment) {
...
//            return new ViewHolder(mLayoutInflater.inflate(R.layout.performance_typec_item, parent, false));
            return new TargetManagementSelectRecyclerViewAdapter.ItemViewHolder(mLayoutInflater.inflate(R.layout.select_department_item, parent, false));
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        }else if (holder instanceof TargetManagementSelectRecyclerViewAdapter.ItemViewHolder) {

            TargetManagementSelectRecyclerViewAdapter.ItemViewHolder viewHolder = (TargetManagementSelectRecyclerViewAdapter.ItemViewHolder) holder;
