...
public class PerformanceEnquiryCFragment extends Fragment implements ObservableScrollViewCallbacks , CalendarView.OnCalendarClickListener{
    ...
    private PerformanceCRecyclerViewAdapter adapter;
    ...
    public PerformanceEnquiryCFragment() {
     ...
     */
    public static PerformanceEnquiryCFragment newInstance(String param1, int param2) {
        PerformanceEnquiryCFragment fragment = new PerformanceEnquiryCFragment();
    ...
    private void initUi(){
        ...
        adapter = new PerformanceCRecyclerViewAdapter(getActivity(), dataList, this);
