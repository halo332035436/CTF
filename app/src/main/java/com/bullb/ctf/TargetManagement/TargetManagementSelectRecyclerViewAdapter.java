...
public class TargetManagementSelectRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    public static ArrayList<Department> dataList;
    final Context mContext;
    private final LayoutInflater mLayoutInflater;
    private static final int TYPE_ITEM = 1;

    public TargetManagementSelectRecyclerViewAdapter(Context context, ArrayList<Department> dataList) {
