...
public class TargetRecyclerViewAdapter_Summary  extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private ArrayList<Department> viewableList;


    public TargetRecyclerViewAdapter_Summary(Context context, Fragment fragment, ArrayList dataList, String userType) {
        mContext = context;
