package com.bullb.ctf.ServiceEvaluation;
...
//        ll.addView(webview, param);
        ...
        Log.d("WebView cbc", BuildConfig.SERVICE_EVA_URL + "?iv="+ivString+"&id="+ desId);
//        webview.setData(BuildConfig.PERFORM_ASSESS_URL + "?iv="+ivString+"&id="+ desId);
    ...
    private void setToolbar(){
        ...
        toolbarTitle.setText(getString(R.string.service_evaluation));
