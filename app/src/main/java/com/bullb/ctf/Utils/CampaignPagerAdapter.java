...
public class CampaignPagerAdapter extends PagerAdapter {
    ...
    public CampaignPagerAdapter(Context context, ArrayList<Campaign> campaignList) {
    ...
    public Object instantiateItem(ViewGroup container, final int position) {
        ...
        Glide.with(context).load(campaignList.get(position).image_url).into(bannerImage);
...
//                intent.putExtra("url",campaignList.get(position).url);
                intent.putExtra("n_id",campaignList.get(position).id);
                intent.setClass(context, WebViewActivity.class);
                if(campaignList.get(position).id!=null) {
