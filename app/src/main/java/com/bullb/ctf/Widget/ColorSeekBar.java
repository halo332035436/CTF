...
/**
* Created by oscarlaw on 10/14/2016.
*/

public class ColorSeekBar  extends View{
    private int mBackgroundColor = 0xffffffff;
    private int[] mColors = new int[]{0xFFFFFF, 0x000000};
    ;
    ...
    protected void applyStyle(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        mBackgroundColor = ContextCompat.getColor(context,R.color.orange);
        mBarHeight = SharedUtils.dpToPx(2);
        mThumbHeight = SharedUtils.dpToPx(30);
        mBarMargin =  SharedUtils.dpToPx(5);
        a.recycle();
